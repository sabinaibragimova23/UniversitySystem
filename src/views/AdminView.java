...
public class AdminView extends BaseView {
    ...
    public static void run(Admin admin) throws IOException {
        ...
        while (active) {
            ...
            switch (option) {
                ...
                case 0: System.out.println(AppContext.tr("logout") + "."); active = false; break;
    ...
    private static void showMenu() {
        separator();
        System.out.println(AppContext.tr("adminMenu"));
        System.out.println("1 - " + AppContext.tr("listUsers"));
        System.out.println("2 - " + AppContext.tr("addUser"));
        System.out.println("3 - " + AppContext.tr("removeUser"));
        System.out.println("4 - " + AppContext.tr("updateUser"));
        System.out.println("5 - " + AppContext.tr("viewLogs"));
        System.out.println("6 - " + AppContext.tr("searchUsers"));
        System.out.println("7 - " + AppContext.tr("switchLanguage"));
    ...
    private static void listUsers() {
        ...
        for (User u : users)
            System.out.println("  [" + u.getClass().getSimpleName() + "] " + u.getFirstName() + " " + u.getLastName() + " | login: " + u.getLogin());
    }
    ...
    private static void addUser(Admin admin) throws IOException {
        ...
        switch (role) {
            ...
            case 2:
                ...
                TeacherType ttype;
                switch (pos) { case 1: ttype = TeacherType.TUTOR; break; case 3: ttype = TeacherType.SENIOR_LECTOR; break; case 4: ttype = TeacherType.PROFESSOR; break; default: ttype = TeacherType.LECTOR; }
            ...
            case 3:
                ...
                ManagerType mtype;
                switch (mt) { case 2: mtype = ManagerType.DEAN_OFFICE; break; case 3: mtype = ManagerType.DEPARTMENT; break; default: mtype = ManagerType.OR; }
    ...
    private static void removeUser(Admin admin) throws IOException {
        ...
        User target = null;
        for (User u : DataStorage.getUsers()) if (u.getLogin() != null && login.equals(u.getLogin())) { target = u; break; }
    ...
    private static void updateUser(Admin admin) throws IOException {
        ...
        System.out.print("New first name (Enter = keep): "); String newFirst = reader.readLine().trim();
        System.out.print("New last name (Enter = keep): ");  String newLast  = reader.readLine().trim();
    ...
    private static void searchUsers() throws IOException {
        ...
        for (User u : DataStorage.getUsers()) {
            ...
            if (fn.contains(query) || ln.contains(query) || lg.contains(query)) found.add(u);
        }
    ...
    private static void switchLanguage(Admin admin) throws IOException {
        ...
        successMsg(AppContext.tr("langChanged") + lang);
    }
}